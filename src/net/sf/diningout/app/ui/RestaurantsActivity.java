 ...
 */
public class RestaurantsActivity extends BaseNavigationDrawerActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,
				R.layout.restaurants_navigation, R.id.sort, getResources().getStringArray(
						R.array.restaurants_sort));
